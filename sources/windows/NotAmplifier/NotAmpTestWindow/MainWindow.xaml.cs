...
namespace NotAmpTestWindow
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void sliderPKM_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e)
        {
            ...
            //Debug.Print(new NotAmplifier.Protocol.Message("pkm", (Int16)sliderPKM.Value, 0, 0));
            
            SendNapMessage(new Message("pkm", (Int16)sliderPKM.Value, 0, 0));
        }
    }
}
